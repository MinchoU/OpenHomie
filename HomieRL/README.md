...
python legged_gym/legged_gym/scripts/train.py --task g1_rough_custom3 --num_envs 4096 --headless --run_name g1_rough_custom3 --rl_device cuda:0 --sim_device cuda:0 --viser
```
